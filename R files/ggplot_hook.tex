...
\urlstyle{same}
\hypersetup{
  pdftitle={Project\_Penguin\_Markdown},
  pdfauthor={Ei Nghon Phoo},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Project\_Penguin\_Markdown}
...
\includegraphics{ggplot_hook_files/figure-latex/pressure-1.pdf}
